...
$db_username = '84122_back2'; // hier komt jouw FTP username
$db_password = 'fY@72cm6';
//--> Bijv. :: https://passwordsgenerator.net/
$db_database = '84122_back2'; // Je kan maximaal 5 databases aanmaken op https://pma.ict-lab.nl/
